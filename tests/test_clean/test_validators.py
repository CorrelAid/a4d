...
def test_fix_patient_id_recovers_a_short_id_too():
    ...
    df = pl.DataFrame({"patient_id": ["MM_NO97", "MM_NO097"], "sheet_name": "Jan24"})
...
def test_fix_patient_id_ambiguous_candidates_are_sentinelled():
    ...
    df = pl.DataFrame({"patient_id": ["KH_NP02", "KH_NP021", "KH_NP023"], "sheet_name": "Jan24"})
...
def test_fix_patient_id_candidate_must_be_in_the_same_tracker():
    ...
    """
    df = pl.DataFrame({"patient_id": ["MM_NO97", "MM_NO096", "MM_NO001"], "sheet_name": "Jan24"})
