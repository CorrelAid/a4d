...
def test_create_table_patient_data_static(
    cleaned_patient_data_files: list[Path],
    tmp_path: Path
):
    """Test creation of static patient data table."""
    output_dir = tmp_path / "output"

    output_file = create_table_patient_data_static(
        cleaned_patient_data_files,
        output_dir
    )
...
def test_create_table_patient_data_monthly(
    cleaned_patient_data_files: list[Path],
    tmp_path: Path
):
    ...
    output_file = create_table_patient_data_monthly(
        cleaned_patient_data_files,
        output_dir
    )
...
def test_create_table_patient_data_annual(
    cleaned_patient_data_files: list[Path],
    tmp_path: Path
):
    ...
    output_file = create_table_patient_data_annual(
        cleaned_patient_data_files,
        output_dir
    )
...
def test_create_table_patient_data_annual_filters_pre_2024(
    tmp_path: Path
):
