...
KNOWN_ISSUES = {
    ...
    "2025_06_North Okkalapa General Hospital A4D Tracker_patient_cleaned.parquet": {
        "patient_id_format": "R replaces MM_QD097/098/099 with 'Undefined' due to format validation. Python correctly preserves original IDs.",
    },
}
...
FILE_COLUMN_EXCEPTIONS = {
    ...
    "2025_06_Mahosot Hospital A4D Tracker_patient_cleaned.parquet": {
        "reason": "Patient LA_QA054 has invalid insulin_regimen value 'nph' (lowercase). R uppercases to 'NPH', Python preserves original. Both should reject as invalid.",
...
REQUIRED_COLUMN_EXCEPTIONS = {
    ...
    "2021_Mandalay Children's Hospital A4D Tracker_patient_cleaned.parquet": {
        "status": "Patient MM_QA072 has missing status in February 2021 in source Excel file",
    },
    "2021_Preah Kossamak Hospital A4D Tracker_patient_cleaned.parquet": {
        "status": "Patient KH_QD017_PK has missing status in source Excel file",
    },
    "2022_Chiang Mai Maharaj Nakorn A4D Tracker_patient_cleaned.parquet": {
        "status": "Patients TH_QB027, TH_QB028, TH_QB029, TH_QB030 have missing status in source Excel file",
    },
    "2022_Chulalongkorn Hospital A4D Tracker_patient_cleaned.parquet": {
        "status": "Patients TH_QH006, TH_QH007, TH_QH008 have missing status in source Excel file",
    },
    "2022_Kantha Bopha Hospital A4D Tracker_patient_cleaned.parquet": {
        "status": "Patient KH_QD168 has missing status in source Excel file",
    },
    "2022_Likas Women & Children's Hospital A4D Tracker_patient_cleaned.parquet": {
        "status": "Patient MY_QC013 has missing status in source Excel file",
    },
    "2022_Mandalay Children's Hospital A4D Tracker_patient_cleaned.parquet": {
        "status": "Patients MM_QA078, MM_QA079, MM_QA080, MM_QA081, MM_QA082, MM_QA083 have missing status in source Excel file",
    },
    "2022_Penang General Hospital A4D Tracker_patient_cleaned.parquet": {
        "status": "Patient MY_QF013 has missing status in source Excel file",
    },
    "2022_Putrajaya Hospital A4D Tracker_DC_patient_cleaned.parquet": {
        "status": "Patient MY_QE011 has missing status in source Excel file",
    },
    "2022_Sarawak General Hospital A4D Tracker_DC_patient_cleaned.parquet": {
        "status": "Patients MY_QJ017, MY_QJ018, MY_QJ020 have missing status in source Excel file",
    },
    ...
    "2023_Mahosot Hospital A4D Tracker_patient_cleaned.parquet": {
        "status": "Patient LA_QA082 has missing status in source Excel file",
    },
    "2023_Nakornping Hospital A4D Tracker_patient_cleaned.parquet": {
        "status": "Patient TH_QF005 has missing status in source Excel file",
    },
    "2023_Surat Thani Hospital A4D Tracker_patient_cleaned.parquet": {
        "status": "Patient TH_QG024 has missing status in source Excel file",
    },
    "2024_Likas Women & Children's Hospital A4D Tracker_patient_cleaned.parquet": {
        "status": "Patient MY_QC018 has missing status in source Excel file",
    },
    "2024_Yangon General Hospital A4D Tracker_patient_cleaned.parquet": {
        "status": "Patients MM_QF067 and MM_QF068 have missing status in source Excel file",
    },
}
