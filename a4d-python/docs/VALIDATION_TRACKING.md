...
- ⚠️  Note: Minor string normalization difference remains: Python preserves "MY_SM003_SB" while R normalizes to "MY_SM003" (not data loss, just different normalization)
