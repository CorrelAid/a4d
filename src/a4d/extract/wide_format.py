"""Wide-format Mandalay tracker reshaping (R steps 1.4a and 1.4b).
...
def handle_wide_format_columns(df: pl.DataFrame, filename: str) -> pl.DataFrame:
    """Expand 2020-2021 Mandalay wide-format columns into rows (R step 1.4a).
...
def handle_wide_format_cells(df: pl.DataFrame, filename: str) -> pl.DataFrame:
    """Split 2017-2019 Mandalay comma-separated ``Released To`` cells (R step 1.4b)."""
