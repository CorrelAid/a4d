...
def read_patient_rows(ws, data_start_row: int, num_columns: int) -> list[tuple]:
    ...
    -- 2024_Mahosot's Jun24 LA-QA088 is a complete patient row that simply lost
...
def join_static_sheet(
    ...
    workbook -- 2023/2024 Mahosot write ``LA-QA056`` against a Patient List
    entry of ``LA_QA056`` -- and on the raw key those rows kept their
